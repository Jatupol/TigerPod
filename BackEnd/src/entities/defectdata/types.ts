// server/src/entities/defectdata/types.ts
/**
 * DefectData Entity Types - Complete Separation Entity Architecture
 * SPECIAL Pattern Implementation
 *
 * REFACTORED: Now uses shared base types from shared-types.ts
 ...
 * ✅ Self-contained defectdata type definitions
...
/*
=== DEFECTDATA ENTITY TYPES FEATURES ===

COMPLETE TYPE DEFINITIONS:
✅ DefectData interface matching database schema exactly
✅ Extends BaseSpecialEntity for audit fields
✅ All database fields properly typed
✅ Foreign key relationships documented

DATA TRANSFER OBJECTS:
✅ CreateDefectDataRequest for new records
✅ UpdateDefectDataRequest for updates
✅ Proper optional/required field handling
✅ Type-safe data validation

QUERY & FILTERING:
✅ DefectDataQueryOptions extending SpecialQueryOptions
✅ Defect-specific filters (station, linevi, inspector, etc.)
...
ANALYTICS & REPORTING:
✅ DefectDataSummary for dashboard data
✅ DefectDataProfile for detailed views
✅ DefectDataTrend for charts and analytics
✅ InspectorPerformance for quality metrics

VALIDATION FRAMEWORK:
✅ DefectDataValidation interface
...
✅ Station validation (OQA, FVI, QC, INS)
✅ Line VI code validation
✅ Group VI code validation
✅ Inspector name pattern validation
✅ Quantity limits and constraints

CONFIGURATION:
✅ Primary key configuration for SPECIAL pattern
✅ Entity configuration with proper API paths
...
✅ Defect type relationships
✅ Tray and position tracking
...
This types file provides comprehensive type definitions for the defectdata
entity following the SPECIAL pattern while maintaining complete architectural
separation and supporting all Manufacturing Quality Control workflows.
*/