// server/src/entities/defectdata/model.ts
/**
 * DefectData Entity Model - Complete Separation Entity Architecture
 ...
 * ✅ Self-contained defectdata data access layer
...
/*
=== DEFECTDATA MODEL FEATURES ===

COMPLETE CRUD OPERATIONS:
✅ Extends GenericSpecialModel for full CRUD capability
✅ Create, read, update, delete with validation
✅ Proper error handling and transactions
✅ Type-safe data transformation

DEFECTDATA-SPECIFIC QUERIES:
✅ getByInspectionNo() - Get all records for an inspection
✅ getByStationAndDateRange() - Station-based reporting
✅ getByInspector() - Inspector performance analysis
✅ getProfile() - Detailed record with related data
✅ inspectionNumberExists() - Validation helper
✅ validateDefectId() - Foreign key validation

ANALYTICS & REPORTING:
✅ getSummary() - Comprehensive statistics
✅ getTrends() - Time-based trend analysis
✅ getInspectorPerformance() - Inspector metrics
✅ Advanced filtering with getByFilters()

MANUFACTURING DOMAIN FEATURES:
✅ Station-based analysis (OQA, FVI, QC, INS)
✅ Line VI and Group VI organization
...
✅ DefectDataQueryOptions to SpecialQueryOptions
✅ Proper type conversion and validation
✅ NULL value handling

COMPLETE SEPARATION ARCHITECTURE:
✅ No cross-entity dependencies
✅ Self-contained data access layer
✅ Generic pattern compliance
✅ Manufacturing domain optimized
✅ Type-safe throughout

This model provides comprehensive data access for defectdata
