...
class SysconfigService extends generic_service_1.GenericSerialIdService {
    ...
    async testSmtpConnection(testEmail, userId) {
        try {
            ...
            console.log(`🔧 SMTP Config - Server: ${activeConfig.smtp_server}, Port: ${activeConfig.smtp_port || 587}, Auth: ${requiresAuth ? 'Yes' : 'No'}`);
            ...
            if (requiresAuth) {
                ...
                console.log(`🔐 Using authentication with user: ${activeConfig.smtp_username}`);
            }
            else {
